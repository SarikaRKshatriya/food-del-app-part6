...
import burger2Logo from "./assets/burgerking.jpg";
import KFCLogo from "./assets/KFC.jpg";
import pizzaLogo from "./assets/pizza.jpg";
import choleLogo from "./assets/salad.jpg";
import saladLogo from "./assets/chole.jpg";
import andhraThali from "./assets/andhraThali.jpg";
...
const RestrauntCard = ({
  ...
  return (
    <div className="card" style={backgroundStyle}>
      <img className="img-height" src={cloudinaryImageId} />
      <h3>{name}</h3>
      <h4>{avgRating}</h4>
      <h4>{cuisines.join(", ")}</h4>
